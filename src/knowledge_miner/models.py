...
class Source(Base):
    ...
    query_id: Mapped[str | None] = mapped_column(String, nullable=True, index=True)
    query_step_number: Mapped[int | None] = mapped_column(Integer, nullable=True)
    query_source_number: Mapped[int | None] = mapped_column(Integer, nullable=True)
